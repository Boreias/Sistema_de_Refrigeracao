...
const TempLigar = require('./model/dbHistorico_sensor');
...
app.post('/HistoricoSensor', (req, res, next) => {
...
app.get('/HistoricoSensor', (req, res, next) => {
...
app.get('/HistoricoSensor/:identificador', (req, res, next) => {
...
app.put('/HistoricoSensor/:identificador', (req, res, next) => {
...
/*
app.delete('/HistoricoSensor/:identificador', (req, res, next) => {
